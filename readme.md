...
# Air Info RESTful API in laravel
> **Note:** This repository contains the core code of a Flight system to show flight info in a RESTful way.
...
* Flexiable data query
* Easily access related with adding extra optional query
